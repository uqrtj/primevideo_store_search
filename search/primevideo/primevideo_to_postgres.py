...
r = requests.post('https://www.primevideo.com/gp/video/api/search?phrase=malayalam%20movies&startIndex=20')
r_dictionary = r.json()
...
try:
    ...
    for pagination_start in range(0, r_dictionary['totalItems'], 20):
        prime_url = "https://www.primevideo.com/gp/video/api/search?phrase=malayalam%20movies&startIndex=" + str(pagination_start)
        print(prime_url)
